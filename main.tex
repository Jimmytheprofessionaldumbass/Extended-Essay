...
\section{Method}
The constants in the lugre friction model ($\sigma_{0}$, $\sigma_{1}$, etc), will be found by measuring steady friction force at various velocities \cite{p:rvstlg}. This will be done with a calibrated force meter
